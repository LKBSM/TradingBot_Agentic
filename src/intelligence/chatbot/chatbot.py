...
class Chatbot:
    ...
    def chat_events(
        ...
        # (identity/rules/tools access) + the variable signal_summary AFTER it.
        # Anthropic reads the cached prefix (~90% cheaper/faster prefill) on every
        # turn; the 60s-TTL summary refresh only re-processes its own small block.
