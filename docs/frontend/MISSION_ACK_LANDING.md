...
3. **Hero différenciateur unique** (cf. `client_relevance_review.md` HISTORIQUE — actualisé 2026-05-27 par pivot positioning post-audit) : **Méthodologie publique transparente** + 12 sources académiques + calendrier événementiel + intervalle conformel + chatbot Sentinel pilier. **Tous claims chiffrés (PF 1.30, 329 setups, IC 95 %) retirés** tant que validation OOS pending. `edge_claim=False` assumé. Voir `docs/governance/decisions/2026-05-27_pivot_positioning_audit.md`.
...
- ✅ `docs/governance/decisions/2026-05-26_5_political_locks.md` HISTORIQUE — D1 Vision B confirmée · D2 DEFER M3 (bootstrap legal) · ~~D3 pricing $0/$29/$79/$1990~~ → **RÉVISÉ 2026-05-27 → FREE / 9€ / 19€ + INSTITUTIONAL retiré grille publique** (cf. `decisions/2026-05-27_pivot_positioning_audit.md`) · D4 instruments **XAU + EUR seuls** en GA · D5 vocabulaire « analyses » + USP « honest confidence »
