 ...
 *
 * The brand block (mission BRD-1) sits above the pulsing placeholder — a
 * natural moment to be seen. It is ADDED, not a replacement: every loading
 * placeholder bar below is untouched, so the state still reads as "loading".
 */
